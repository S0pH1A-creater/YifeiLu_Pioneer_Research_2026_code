...
3 months · 6 months · 1 year · 2 years · 3 years · 5 years (calendar lookback; uses available history if the series is shorter). Minimum window length for a GARCH fit: 60 trading days. Default on 1-year regime notebooks: **3 years**, rolling **monthly**.
