...
Write per-ticker markdown + figures under V3-Models_result/results/{TICKER}/,
...
**Source:** `V3-Models_result/results/{{TICKER}}/` after methodological fixes (see `V3_CHANGES.md`).  
