...
Writes under V3-Models_result/results/parameters/:
...
ROOT = Path(__file__).resolve().parents[1]  # V3-Models_result/
REPO = ROOT.parent
        ...
        metas.append(
            {
                ...
                "panel_rel": f"../../V3-Models_result/results/parameters/{mode}/{stem}/panel.png",
...
**Source:** `V3-Models_result/results/parameters/{rolling_mode}/`  
