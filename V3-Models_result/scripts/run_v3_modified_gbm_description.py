        ...
        fig = _page(
            ...
            [
                ...
                (
                    "Code",
                    [
                        "Notebooks: V3-Models_result/modified gbm notebook/20*_modified_gbm.ipynb. Functions: estimate_modified_gbm, calibrate_ticker, simulate_modified_gbm_rolling.",
