...
Writes:
  V4-Models_result/results/7d_1min/<window_id>/
...
STUDIES = [
    ...
    ("Modified GBM", "modified gbm notebook", "7d_1min_modified_gbm.ipynb", "modified_gbm"),
...
**Source:** `V4-Models_result/results/7d_1min/{WINDOW_ID}/parameters/{mode}/`  
...
**Window:** `{WINDOW_ID}`.  
**Source:** `V4-Models_result/results/7d_1min/{WINDOW_ID}/{{TICKER}}/`  
...
Canonical numbers/figures: `V4-Models_result/results/7d_1min/{WINDOW_ID}/`.
