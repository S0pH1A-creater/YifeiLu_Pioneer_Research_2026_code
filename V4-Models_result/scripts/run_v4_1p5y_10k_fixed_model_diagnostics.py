#!/usr/bin/env python3
"""Model-diagnostic report for the V4 1.5-year fixed 10k study."""
...
def apply_config() -> None:
    v4.patch_v3_wrap()
    diag.PDF_NAME = "V4_1p5y_fixed_model_diagnostics.pdf"
    diag.NB_NAME = "V4_1p5y_fixed_model_diagnostics.ipynb"
    diag.REPORT_TITLE = "V4 model diagnostic verification"
    diag.STUDY_NAME = "V4 1.5-year fixed empirical study 10000 paths"
