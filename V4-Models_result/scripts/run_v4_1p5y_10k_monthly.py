#!/usr/bin/env python3
"""Assemble the V4 1.5-year monthly 10k study the way V3 monthly is laid out.

Runs missing LSM cells, then grouped reports, stock, PE, moneyness,
diagnostics, return analysis, and MD-GBM spec. Leaves the GARCH LRNVR
documentation folder untouched.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if "params" not in skip:
        ...
        import run_v4_1p5y_10k_monthly_parameter_estimation as pe
    ...
    if "diagnostics" not in skip:
        ...
        import run_v4_1p5y_10k_monthly_model_diagnostics as diag

        diag.main()
    if "returns" not in skip:
        print("===== return analysis =====", flush=True)
        import run_v4_1p5y_10k_monthly_return_analysis as ra
