...
def apply_config() -> None:
    ...
    def _paths():
        ...
        return (
            cache,
            short / "V4_1p5y_monthly_stock_price.pdf",
            short / "V4_1p5y_monthly_stock_price.ipynb",
        )
    ...
    rb["group_intro"] = [
        "Companion stock-path report. This file keeps MD-GBM, GBM, GARCH, Merton, and GARCH–Merton, whose P dynamics come from lookback returns. MD-GBM means Markov Directional Geometric Brownian Motion. Rankings are within this group; they are not compared here with Heston / Heston–Merton.",
    ]
    stock.STOCK_GROUPS = {
        "return_based": rb,
        "option_implied": stock.STOCK_GROUPS["option_implied"],
    }
