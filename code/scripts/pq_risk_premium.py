"""P → Q for Merton (Pan μ_J*) used by the 1.5-year monthly study.

GARCH is in garch_duan_lrnvr.py. GBM / MD-GBM use an additive shift in the notebooks.
"""
...
def _fit_nls(resid, x0: np.ndarray, lo: np.ndarray, hi: np.ndarray, max_nfev: int = 60):
    ...
    step with finite-difference Jacobian.
    """
